...
import {IdaiDocumentsModule} from '../../src/ts/documents/idai-documents.module';
import {IdaiMessagesModule} from '../../src/ts/messages/idai-messages.module';
import {IdaiWidgetsModule} from '../../src/ts/widgets/idai-widgets.module';
...
import {ConfigReader} from '../../src/ts/configuration/config-reader';
import {IdaiFieldPrePreprocessConfigurationValidator} from '../../src/ts/configuration/idai-field-pre-preprocess-configuration-validator';
import {ConfigurationValidator} from '../../src/ts/configuration/configuration-validator';
import {IdaiFieldMapModule} from '../../src/ts/map/idai-field-map.module';
import {TypeDefinition} from '../../src/ts/configuration/type-definition';
