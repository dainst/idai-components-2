...
System.register(['@angular/platform-browser-dynamic', './app.component', '@angular/http', '@angular/core', "../lib/ts/datastore/datastore", "../lib/ts/core-services/messages", "./memory-datastore", "../lib/ts/object-edit/config-loader", "../lib/ts/core-services/persistence-manager", "../lib/ts/md", '@angular/router', '@angular/common'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var platform_browser_dynamic_1, app_component_1, http_1, core_1, datastore_1, messages_1, memory_datastore_1, config_loader_1, persistence_manager_1, md_1, router_1, common_1;
    return {
        setters:[
