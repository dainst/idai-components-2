...
var MapComponent = (function () {
    ...
    MapComponent.prototype.addParentDocumentGeometryToMap = function () {
        if (!this.parentDocument || !this.parentDocument.resource.geometry)
            return;
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], MapComponent.prototype, "parentDocument", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
