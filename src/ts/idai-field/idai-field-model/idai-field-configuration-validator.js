...
var md_internal_1 = require("../../core/messages/md-internal");
/**
        ...
        if ('Project' in recordedInRelations) {
            for (var _c = 0, _d = recordedInRelations['Project']; _c < _d.length; _c++) {
                ...
                if (!(type in recordedInRelations) || !recordedInRelations[type]
                    ...
                    msgs.push([md_internal_1.MDInternal.VALIDATION_ERROR_INCOMPLETERECORDEDIN, type]);
                }
            }
        }
        else {
            msgs.push([md_internal_1.MDInternal.VALIDATION_ERROR_NOPROJECTRECORDEDIN]);
        }
        return msgs;
    };
    /**
    ...
    IdaiFieldConfigurationValidator.findMissingViewType = function (views, types) {
        ...
        for (var _i = 0, views_1 = views; _i < views_1.length; _i++) {
            ...
            if (typeNames.indexOf(view.operationSubtype) == -1)
                msgs.push([md_internal_1.MDInternal.VALIDATION_ERROR_MISSINGVIEWTYPE, view.operationSubtype]);
            var supported = false;
            ...
            if (!supported) {
                msgs.push([md_internal_1.MDInternal.VALIDATION_ERROR_NONOPERATIONVIEWTYPE, view.operationSubtype]);
            }
        }
        return msgs;
    };
