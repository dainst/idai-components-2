...
var IdaiFieldAppConfigurator = (function () {
    ...
    IdaiFieldAppConfigurator.prototype.go = function (projectConfigurationPath) {
        this.configLoader.go(projectConfigurationPath, new configuration_preprocessor_1.ConfigurationPreprocessor(this.defaultTypes, this.defaultFields, this.defaultRelations), new idai_field_configuration_validator_1.IdaiFieldConfigurationValidator([]));
    };
