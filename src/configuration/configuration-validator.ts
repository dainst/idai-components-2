...
export class ConfigurationValidator {
    ...
    private static VALID_INPUT_TYPES = ['input', 'inputs', 'text', 'dropdown', 'dropdownRange', 'radio',
        'checkboxes', 'multiselect', 'unsignedInt', 'float', 'unsignedFloat', 'dating', 'dimension',
        'boolean', 'date'];
