...
export class ConfigurationErrors {
    ...
    public static INVALID_CONFIG_MISSINGVALUELIST: string = 'config/error/missingvaluelist';
    public static INVALID_CONFIG_MISSINGFIELDNAME: string = 'config/error/missingfieldname';
    public static INVALID_CONFIG_MISSINGRELATIONTYPE: string = 'config/error/missingrelationtype';
}