...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            { pattern: 'src/core/**/*.js', included: false, watched: true },
            { pattern: 'src/field/**/*.js', included: false, watched: true },
            { pattern: 'src/core/**/*.html', included: false, watched: true },
            { pattern: 'src/field/**/*.html', included: false, watched: true },
