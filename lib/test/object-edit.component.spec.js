System.register(['@angular/core/testing', '@angular/compiler/testing', '../ts/object-edit/object-edit.component', "@angular/core", "../ts/core-services/persistence-manager", "../ts/datastore/datastore", "../ts/core-services/messages", "../ts/object-edit/relations-provider"], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, object_edit_component_1, core_1, persistence_manager_1, datastore_1, messages_1, relations_provider_1;
    var TestComponent;
    /**
    ...
    function main() {
        testing_1.xdescribe('ObjectEditComponent', function () {
            ...
            var MockRelationsProvider = (function () {
                function MockRelationsProvider() {
                }
                return MockRelationsProvider;
            }());
            ...
            testing_1.beforeEachProviders(function () { return [
                ...
                core_1.provide(relations_provider_1.RelationsProvider, { useClass: MockRelationsProvider })
            ]; });
