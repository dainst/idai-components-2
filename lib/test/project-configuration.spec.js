System.register(['@angular/core/testing', "../app/object-edit/project-configuration", "../app/core-services/md"], function(exports_1, context_1) {
    "use strict";
    ...
    function main() {
        testing_1.describe('ProjectConfiguration', function () {
            ...
            testing_1.it('should let types inherit fields from parent types', function () {
                ...
                testing_1.expect(fields[0].fieldDefinition).toBe('fieldA');
                testing_1.expect(fields[1].fieldDefinition).toBe('fieldB');
            });
