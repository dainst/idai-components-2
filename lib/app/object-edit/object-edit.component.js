System.register(['@angular/core', "./persistence-manager", "@angular/common", "./edit-form.component", "./config-loader", "./load-and-save-service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, persistence_manager_1, common_1, edit_form_component_1, config_loader_1, load_and_save_service_1;
                ...
                ObjectEditComponent.prototype.ngOnChanges = function () {
                    ...
                    if (this.object) {
                        this.loadAndSaveService.load(this.object).then(function () {
                            return _this.setFieldsForObjectType(_this.object, _this.projectConfiguration);
                        });
                    }
                };
