System.register(['@angular/core', "./persistence-manager", "@angular/common", "./relation-picker-group.component", "./valuelist.component", "../core-services/messages", "../core-services/md", "./config-loader"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, persistence_manager_1, common_1, relation_picker_group_component_1, valuelist_component_1, messages_1, md_1, config_loader_1;
        ...
        execute: function() {
            ...
            ObjectEditComponent = (function () {
                ...
                ObjectEditComponent.prototype.ngOnChanges = function () {
                    if (!this.projectConfiguration || !this.relationsConfiguration)
                        return;
                    if (this.object) {
