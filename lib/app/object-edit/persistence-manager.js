    ...
    return {
        ...
        execute: function() {
            ...
            PersistenceManager = (function () {
                ...
                PersistenceManager.prototype.persist = function () {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        _this.persistIt(_this.document).then(function () {
                            Promise.all(_this.makeGetPromises(_this.document, _this.oldVersion)).then(function (targetDocuments) {
                                Promise.all(_this.makeSavePromises(_this.document, targetDocuments)).then(function () {
                                    _this.unload();
                                    resolve();
                ...
                PersistenceManager.prototype.pruneInverseRelations = function (id, targetResource) {
                ...
                PersistenceManager.prototype.setInverseRelations = function (document, targetDocument) {
                    for (var prop in document['resource']) {
                        if (!document['resource'].hasOwnProperty(prop))
                            continue;
                        if (!this.relationsConfiguration.isRelationProperty(prop))
                            continue;
                        for (var _i = 0, _a = document['resource'][prop]; _i < _a.length; _i++) {
                            var id = _a[_i];
                            if (id != targetDocument['@id'])
                                continue;
