    ...
    return {
        ...
        execute: function() {
            ...
            PersistenceManager = (function () {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        _this.persistIt(_this.document).then(function () {
                            Promise.all(_this.makeGetPromises(_this.document, _this.oldVersion)).then(function (targetDocuments) {
                                Promise.all(_this.makeSavePromises(_this.resource, targetDocuments)).then(function () {
                                    _this.unload();
                                    resolve();
                ...
                PersistenceManager.prototype.makeSavePromises = function (resource, targetDocuments) {
