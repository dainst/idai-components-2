System.register(['@angular/core', "@angular/common", "./fieldlist.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, fieldlist_component_1;
        ...
        execute: function() {
            ...
            LocalizedComponent = (function () {
                ...
                LocalizedComponent.prototype.languages = function () {
                    if (!this.resource[this.fieldDefinition.field])
                        return [];
                ...
                ], LocalizedComponent.prototype, "resource", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
