    ...
    return {
        ...
        execute: function() {
            ...
            RelationPickerGroupComponent = (function () {
                ...
                RelationPickerGroupComponent.prototype.ngOnChanges = function () {
                    if (this.document)
                ...
                RelationPickerGroupComponent.prototype.validateNewest = function () {
                    var index = this.resource[this.field.field].length - 1;
                ...
                ], RelationPickerGroupComponent.prototype, "document", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ...
                ], RelationPickerGroupComponent.prototype, "primary", void 0);
