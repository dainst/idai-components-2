    ...
    return {
        ...
        execute: function() {
            ...
            FieldlistComponent = (function () {
                ...
                FieldlistComponent.prototype.addItem = function () {
                    if (!this.object[this.fieldDefinition.field])
                        this.object[this.fieldDefinition.field] = [];
                    var newItem = {};
                    for (var _i = 0, _a = this.fieldDefinition.fields; _i < _a.length; _i++) {
                        var itemDefinition = _a[_i];
