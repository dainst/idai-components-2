System.register(['@angular/core', "@angular/common", "./persistence-manager", "../datastore/datastore"], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            ...
            RelationPickerComponent = (function () {
                ...
                RelationPickerComponent.prototype.ngOnChanges = function () {
                    ...
                    var relationId = this.object[this.field.fieldDefinition][this.relationIndex];
                ...
                RelationPickerComponent.prototype.deleteRelation = function () {
                    ...
                    return new Promise(function (resolve) {
                        if (targetId.length == 0) {
                            _this.object[_this.field.fieldDefinition].splice(_this.relationIndex, 1);
                        }
                        else {
                            _this.object[_this.field.fieldDefinition].splice(_this.relationIndex, 1);
                            // todo
                        ...
                        if (_this.object[_this.field.fieldDefinition].length == 0)
                            delete _this.object[_this.field.fieldDefinition];
                        resolve();
                    });
                };
