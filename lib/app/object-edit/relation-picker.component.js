System.register(['@angular/core', "@angular/common", "./persistence-manager", "../datastore/read-datastore"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, persistence_manager_1, read_datastore_1;
    ...
    return {
        ...
        execute: function() {
            ...
            RelationPickerComponent = (function () {
                function RelationPickerComponent(element, datastore, persistenceManager // TODO instead of this the parent object edit component should get addressed for marking an object as changed
                    ) {
                        ...
                        this.datastore.find(this.idSearchString, {})
                            ...
                            for (var i in documents) {
                                ...
                                if (_this.suggestions.length == 5)
                                    break;
                                if (_this.checkSuggestion(documents[i]))
                                    _this.suggestions.push(documents[i]);
                            }
                        }).catch(function (err) {
                 ...
                 * @param object
                 */
                RelationPickerComponent.prototype.checkSuggestion = function (document) {
                ...
                RelationPickerComponent.prototype.deleteRelation = function () {
                    ...
                    return new Promise(function (resolve) {
                        if (targetId.length == 0) {
                            ...
                            _this.resource[_this.field.field].splice(_this.relationIndex, 1);
                            // todo
                            _this.persistenceManager.load(_this.document);
                        }
                ...
                RelationPickerComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [core_1.ElementRef, read_datastore_1.ReadDatastore, persistence_manager_1.PersistenceManager])
