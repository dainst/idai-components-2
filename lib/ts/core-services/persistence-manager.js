System.register(["@angular/core", "../datastore/datastore", "../object-edit/config-loader", "../md"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, datastore_1, config_loader_1, md_1;
    ...
    return {
        ...
        execute: function() {
            ...
            PersistenceManager = (function () {
                function PersistenceManager(datastore, configLoader) {
                ...
                PersistenceManager.prototype.persist = function () {
                    ...
                    return new Promise(function (resolve, reject) {
                        _this.configLoader.getRelationsConfiguration().then(function (relationsConfiguration) {
                        ...
                        }, function (err) { console.error("error while loading relationsconfiguration"); reject(err); });
                    });
                };
                ...
                PersistenceManager = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [datastore_1.Datastore, config_loader_1.ConfigLoader])
                ], PersistenceManager);
